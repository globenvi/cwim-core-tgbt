...
from templates.default.appbar_tpl import appbar_tpl

def tpl_index(page: Page):
    # Добавляем appbar и sidebar на страницу
    page.app_bar = appbar_tpl(page)  # Используем новый appbar_tpl

    # Основной контент страницы
    content = Column([
        Text("Добро пожаловать на главную страницу!", style="headline5"),
        # Добавьте другие элементы контента по необходимости
    ])
...
#         width=200
#     )
#     chat_button = CupertinoFilledButton('Чат', on_click=lambda e: page.go('/chat'))
#
